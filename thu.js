            ...
            if(ThongSo.ListNen[i].list.length>0)
                for (let h = 0; h < ThongSo.ListNen[i].list.length; h++) {
                    ...
                    ttt +=" if( "+ThongSo.ListNen[i].id+"."+ThongSo.ListNen[i].list[h].id+".close >"+ThongSo.ListNen[i].id+"."+ThongSo.ListNen[i].list[h].id+".open ){" +
                        ...
                        +ThongSo.ListNen[i].id+"."+ThongSo.ListNen[i].list[h].id+"."+"lanendo= false;}\n else{" +
                        ...
                        +ThongSo.ListNen[i].id+"."+ThongSo.ListNen[i].list[h].id+"."+"lanendo= true;}";
                    ttt +=ThongSo.ListNen[i].id+"."+ThongSo.ListNen[i].list[h].id+"."+"dodai= "+  +ThongSo.ListNen[i].id+"."+ThongSo.ListNen[i].list[h].id+".high -"+    ThongSo.ListNen[i].id+"."+ThongSo.ListNen[i].list[h].id+".low ;\n";
...
client.addStream('XBTUSD', ThongSo.tradeBin, data => {
    let lastCandle = data[data.length - 1];
    {
        if (lastCandle != null && ArDataClient.length != 0 && new Date(DataBucketed[0].timestamp).getTime() != new Date(lastCandle.timestamp).getTime()) {
            ...
            //huyhuy
var idnen1534157824564 ={}; 
idnen1534157824564.name ='Spinning Tops';
  idnen1534157824564.nen1= ArTrend1m[ArTrend1m.length -1] ;
 if( idnen1534157824564.nen1.close >idnen1534157824564.nen1.open ){idnen1534157824564.nen1.lanenxanh= true;
idnen1534157824564.nen1.thannen = idnen1534157824564.nen1.close -idnen1534157824564.nen1.open ;
NaN.nen1.lanendo= false;}
 else{idnen1534157824564.nen1.lanenxanh= false;
idnen1534157824564.nen1.thannen = idnen1534157824564.nen1.open -idnen1534157824564.nen1.close ;
NaN.nen1.lanendo= true;}idnen1534157824564.nen1.dodai= NaN.nen1.high -idnen1534157824564.nen1.low ;
 if((idnen1534157824564.nen1.close-idnen1534157824564.nen1.open) ){ if(ThongSo.ListNen[i].list.length==1){
            CurrentTrend.Nen.type='idnen1534157824564';

            CurrentTrend.Nen.name='Spinning Tops';
        } else      {
            CurrentTrend.Nen.mau.type='idnen1534157824564';

            CurrentTrend.Nen.mau.name='Spinning Tops'
        } }
var MHnenmohinhnennhanchim ={}; 
MHnenmohinhnennhanchim.name ='Maruboru';
  MHnenmohinhnennhanchim.nen1= ArTrend1m[ArTrend1m.length -1] ;
 if( MHnenmohinhnennhanchim.nen1.close >MHnenmohinhnennhanchim.nen1.open ){MHnenmohinhnennhanchim.nen1.lanenxanh= true;
MHnenmohinhnennhanchim.nen1.thannen = MHnenmohinhnennhanchim.nen1.close -MHnenmohinhnennhanchim.nen1.open ;
NaN.nen1.lanendo= false;}
 else{MHnenmohinhnennhanchim.nen1.lanenxanh= false;
MHnenmohinhnennhanchim.nen1.thannen = MHnenmohinhnennhanchim.nen1.open -MHnenmohinhnennhanchim.nen1.close ;
NaN.nen1.lanendo= true;}MHnenmohinhnennhanchim.nen1.dodai= NaN.nen1.high -MHnenmohinhnennhanchim.nen1.low ;
 if(((MHnenmohinhnennhanchim.nen1.lanenxanh&&MHnenmohinhnennhanchim.nen1.close+5>=MHnenmohinhnennhanchim.nen1.high&&MHnenmohinhnennhanchim.nen1.low+5>=MHnenmohinhnennhanchim.nen1.open)||(MHnenmohinhnennhanchim.nen1.lanendo&&MHnenmohinhnennhanchim.nen1.open+5>=MHnenmohinhnennhanchim.nen1.high&&MHnenmohinhnennhanchim.nen1.close+5>=MHnenmohinhnennhanchim.nen1.low)) ){ if(ThongSo.ListNen[i].list.length==1){
            CurrentTrend.Nen.type='MHnenmohinhnennhanchim';

            CurrentTrend.Nen.name='Maruboru';
        } else      {
            CurrentTrend.Nen.mau.type='MHnenmohinhnennhanchim';

            ...
            ed.on('blur', 'input', function (e) {
                ...
                if (!tag) {
                    ...
                    // remove duplicates
                        ...
                        $('.tag-editor-tag', ed).each(function () {
                            let text=$(this).text();
                                     text=text.replace("Khong tim thay","");

                            if (o.autocomplete)
                            if (o.autocomplete.source.indexOf( text )==-1 && !Number.isInteger(parseInt( text ))|| text=="ne"|| text=="nen") $(this).closest('li').remove();
                        });
                }
